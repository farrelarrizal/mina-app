...
<div class="col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-12">
                    <form action="{{ route('dashboard.artikel.update', $article->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <textarea name="content" id="classic-editor" placeholder="Masukkan Konten Artikel" >
                            {{ $article->content }}
                        </textarea>
                        <br>
                        <!-- upload image -->
