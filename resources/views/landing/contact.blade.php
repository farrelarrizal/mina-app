...
<section class="contact-section">
    <div class="container">
        <!-- <div class="d-none d-sm-block mb-5 pb-4">
         ...
         <div class="row">
            <div class="col-12">
                <h2 class="row justify-content-md-center contact-title">Kantor Mina Wisata Islami</h2>
            </div>
                <div class="col-lg-8">
                            ...
                            <div class="row d-flex align-items-end">
                                <div class="col-lg-6 col-md-12">
                                    <div class="we-create-img">
                                        <div class="embed-responsive mbl-image "> 
                                            <img width="320" height="300"src="assets/landing/img/gallery/kantor ketintang.jpg" alt="">         
                                    </div>
                                </div>
                                </div>
                                <div class="col-lg-6 col-md-12">
                        ...
                        <div class="container">
                            <div class="row d-flex align-items-end">
                                <div class="col-lg-6 col-md-12">
                                    <div class="we-create-img">
                                        <div class="embed-responsive mbl-image "> 
                                            <img width="320" height="300"src="assets/landing/img/gallery/kartini2.jpg" alt="">         
                                    </div>
                                </div>
                                </div>
                                <div class="col-lg-6 col-md-12">
